...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="navbar border-gre">
        ...
        >
          <input
            type="text"
            placeholder="search"
            className="w-full md:w-auto bg-gre p-4 pl-6 pr-[12%] md:pr-6 rounded-full placeholder:text-dark-grey md:pl-12"
        ...
        <div className="flex item-center gap-3 md:gap-6 ml-auto">
          ...
          <Link
            to="/editor"
            className="hidden md:flex gap-2 link hover:bg-lg rounded-xl"
          >
          ...
          {access_token ? (
            <>
              <div
                ...
                onBlur={handleBlur}
              >
                <button className="w-12 h-12 mt-0">
                  <img
                    src={profile_img}
